---
name: design
description: Design a new screen or component before coding begins. CTO frames the requirements, Devil's Advocate challenges the UX assumptions, and Frontend agent produces a detailed layout spec. Use /design <screen-name> to get a battle-tested spec before writing any code.
---
...
## Step 3 — Frontend agent specifies the layout

Using the FamilyOS design system (Indigo Heritage, `C.*` tokens, Georgia serif for names, Inter for UI):
