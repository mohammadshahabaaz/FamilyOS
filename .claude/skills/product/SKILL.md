---
name: product
description: Product review — what to build next, feature ranking, and Founder Rule audit. The CTO reviews the current FEATURE_BOARD.md, applies the Founder Rule to all items, ranks them by family value, and produces a prioritized sprint plan.
