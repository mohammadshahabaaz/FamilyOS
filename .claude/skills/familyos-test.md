---
name: familyos-test
description: "Use when writing or running tests in FamilyOS. Covers Vitest unit tests for the relationship engine, auth service, and event service. Ensures 56-test baseline is maintained."
---
...
**56 tests must pass at all times.** Never ship with a failing test.
...
- `schema.prisma` → run all 56 tests + `npx prisma db push`
...
- [ ] `npm test` shows exactly 56 (or 56 + new tests) passing
